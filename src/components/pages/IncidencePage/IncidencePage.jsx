...
const IncidencePage = () => {
    ...
    const progressPercentage = (incidenceStatus.indexOf(incidence.status) / (incidenceStatus.length - 1)) * 100;
    ...
    return (
        <div>
            ...
            {service ? (
                ...
                <button type='button' onClick={handleAsign}>Asignar Servicio</button>
            )}
            <div className="status-container">
                ...
                <p>{updatedDate} {updatedTime}</p>
                <p>{incidence.buildingId?.address} {incidence.buildingId?.number}</p>
            </div>
